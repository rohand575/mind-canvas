      ...
      <div className="relative w-full h-full bg-gray-50 dark:bg-[#1a1a2e] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 z-40">
          <button
            ...
            className="w-11 h-11 rounded-xl flex items-center justify-center bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg shadow-md shadow-black/[0.05] dark:shadow-black/25 ring-1 ring-gray-950/[0.05] dark:ring-white/[0.06] text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 transition-all duration-150"
          >
